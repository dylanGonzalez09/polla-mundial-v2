...
-- Caso adicional del diseno:
-- si el marcador exacto coincide, el cruce es correcto y el equipo que avanza
-- no, entonces suma 3 puntos. Esto solo puede ocurrir cuando el resultado
-- oficial termina empatado a 90 minutos.
