-- La migración 0007 (ocultar admins) recreó las RPC de peers desde la versión
-- original SIN calificar columnas, reintroduciendo la ambigüedad (42702) que
-- la 0003 ya había corregido. Esta migración vuelve a la versión calificada
-- (alias en cada columna) manteniendo el filtro `not is_admin`.
