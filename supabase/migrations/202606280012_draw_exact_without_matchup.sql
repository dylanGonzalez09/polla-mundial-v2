...
-- Ajuste del caso de empate:
-- si el marcador exacto coincide y el oficial termino empatado, suma 3 puntos
-- aunque no se haya acertado el equipo que avanza ni el cruce completo.
