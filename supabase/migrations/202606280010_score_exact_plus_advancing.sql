...
-- Caso faltante del diseño:
-- si el usuario acierta el equipo que avanza y además el marcador exacto,
-- suma 4 puntos aunque el cruce real no coincida con el pronosticado.
  ...
  with scored as (
    select
      ...
      case
        ...
        -- ganador correcto + marcador exacto, con o sin cruce correcto → 4
        when (
